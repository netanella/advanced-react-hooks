...
Give us the change to change things in the DOM before it paints to the screen.
With useEffect we will render twice. Use every time we have a side effect that
will manipulate the DOM in an observable way - use useLayoutEffect.
