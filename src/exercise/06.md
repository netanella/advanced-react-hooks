...
useDebugValue is for showing custom hook information in the React Developer
Tools.

It takes two arguments:

1. object of values to display
2. formatter - useful for computationally expensive calculations that we 
   want to calculate only when devTools is open.
